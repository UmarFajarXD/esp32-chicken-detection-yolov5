...
1. **Notebook 1 (YOLOv5 Training):** [Google Colab - Training Dataset](https://colab.research.google.com/drive/146oC7tRiKyrGkoOr8abisPUKGEYKdqma?usp=sharing)
2. **Notebook 2 (ONNX to C++ Synapedge Compiler):** [Google Colab - Synapedge C++ Compiler](https://colab.research.google.com/drive/13SdKhFEhQA9rOOAzwK2IQix61tl-kN2z?usp=sharing)
